...
const StoryViewer = ({ viewStory, setViewStory }) => {
    ...
    const renderContent = () => {
        switch (viewStory.media_type) {
            ...
            case 'text':
                return (
                    <div className='w-full h-full items-center flex justify-center p-8 text-white text-2xl text-center'>
                        {viewStory.content}
                    </div>
                );
            default:
    ...
    return (
        ...
        >
            <div className="absolute top-0 left-0 w-full h-1 bg-gray-700">
                <div className="h-full bg-white transition-all duration-300 linear"
            ...
            <div className="absolute top-4 left-4 flex items-center space-x-3 p-2 px-4 sm:px-8 backdrop-blur-2xl rounded bg-black/50">
                ...
                />
                <div className="text-white flex font-medium items-center gap-1.5">
