import { Calendar, MapPin, Pen, Verified } from 'lucide-react';
            ...
            <div className='flex flex-col md:flex-row items-start gap-6'>
                ...
                <div className='w-full pt-16 md:pt-0 md:pl-36'>
                    <div className='flex flex-col md:flex-row items-start justify-between'>
                        ...
                        {!profileId &&
                            <button onClick={() => { setShowEdit(true) }} className='flex items-center gap-2 border border-gray-500 hover:bg-gray-50 cursor-pointer px-4 py-2 rounded-lg font-medium transition-colors mt-4 md:mt-0'>
