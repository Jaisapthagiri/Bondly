              ...
              <div className='flex-1'>
                ...
                <div className='flex max-sm:flex-col gap-2 mt-4'>
                  <button
                    ...
                    className='w-full p-2 rounded text-sm bg-gradient-to-r 
                      from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer'
                  >
                    View Profile
                  </button>
